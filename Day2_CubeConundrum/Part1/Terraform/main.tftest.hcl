...
run "test_case_one" {
  ...
  variables {
    game_record = <<EOT
Game 3: 0 blue, 4 red; 1 red, 2 green, 1 blue; 2 green
EOT
  }
  assert {
...
run "test_case_five" {
  ...
  variables {
    game_record = <<EOT
Game 1984: 999 blue, 2 green; 1 blue, 1 red
Game 1: 1 blue, 1 red
EOT
  }
  assert {
...
run "test_case_six" {
  ...
  variables {
    game_record = <<EOT
Game 1984: 1 blue, 999 green; 1 blue, 1 red
Game 1: 1 blue, 1 green; 1 red 1 blue
EOT
  }
  assert {
    condition     = output.result == 1
